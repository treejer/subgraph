...
export function handleTransfer(event: Transfer): void {
    ...
    if(planterFrom) {
        ...
        erc20History.address = event.params.from.toHexString();
        erc20History.event = "TransferOut";
    ...
    if(planterTo) {
        let erc20History = new ERC20History(getCount_ERC20History(COUNTER_ID).toString());
        erc20History.address = event.params.to.toHexString();
        erc20History.event = "TransferIn";
